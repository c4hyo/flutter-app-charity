...
class _PostUpdateScreenState extends State<PostUpdateScreen> {
  ...
  PostBloc _bloc;
  String _token,_title,_description;
  File _thumbnail;
  _addThumbnail(){
    return showDialog(
      context: context,
                  ...
                  child: Column(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            primaryText("Update Thumbnail",fontWeight: FontWeight.bold),
                            SizedBox(height: 20,),
                            (_thumbnail == null)
                            ?GestureDetector(
                              onTap: _addThumbnail,
